...
class Exercise:
    ...
    def find_choices(self, right, wrong, new_sent): #TODO @Kate, rewrite this function
        ...
        """
        global k
        right = re.sub('[йцукенгшщзхъфывапролджэячсмитьбюЙЦУКЕНГШЩЗХЪФЫВАПРОЛДЖЭЯЧСМИТЬБЮ]+','',right)
        wrong = re.sub('[йцукенгшщзхъфывапролджэячсмитьбюЙЦУКЕНГШЩЗХЪФЫВАПРОЛДЖЭЯЧСМИТЬБЮ]+','',wrong)
        choices = [right, wrong]
